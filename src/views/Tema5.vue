...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5
      ...
      .col-lg-8
        ...
        ul.lista-ul--color.t1.ms-4
          ...
          li 
            i.fas.fa-check-double
            | Practicar evaluaciones médicas y manejar las historias clínicas correspondientes, de acuerdo con lo reglamentado en la Resolución 2346 del 2007.
          li 
            i.fas.fa-check-double
    ...
    p La idea es minimizar o eliminar los riesgos a través de modificaciones en las condiciones de trabajo que disminuyan los riesgos para la salud y que mejoren la higiene de los sitios de trabajo. Una vez analizado el resultado de la revisión se propenderá por mejorar las condiciones de salud, a través de actividades de bienestar social. Las enfermedades laborales que sean causadas por peligros higiénicos, entre las que se pueden mencionar enfermedades producidas por riesgo biomecánico, psicosocial, químico, biológico (SARS-CoV2) deben ser gestionadas con programas de vigilancia epidemiológica, cuyo objetivo será mantener la salud de los trabajadores, el bienestar de las familias colombianas y la productividad de las empresas.
    ...
    p.mb-5 La práctica de exámenes médicos ocupacionales es una de las principales actividades del Sistema de Gestión de Seguridad y Salud en el Trabajo, se constituye en un instrumento importante para la elaboración del diagnóstico de las condiciones de salud de la población trabajadora, justifican la implementación de los sistemas de vigilancia epidemiológica y permite planificar la intervención de los factores de riesgo higiénicos identificados en los ambientes de trabajo. 

    p.text-center <b>A continuación, se presentan los pasos a seguir por las empresas para la gestión de exámenes médicos ocupacionales:</b>
    ...
    .row.justify-content-center.mb-5
      .col-lg-8
        ...
        p A partir de este concepto se puede determinar que los hábitos necesarios para llevar una vida saludable son los siguientes: alimentación saludable, evitar el exceso de bebidas alcohólicas, realizar mínimo treinta minutos diarios de ejercicio físico, siendo suficiente caminar a paso rápido, dormir ocho horas mínimo, y mantener hábitos de higiene tanto en lo personal como en el ámbito doméstico y en el trabajo.
      .col-lg-4
        figure
    ...
    p.mb-4 La buena gestión de residuos salvaguarda la salud de los trabajadores, la calidad de vida, el cuidado del medio ambiente y la preservación de los recursos naturales.
    p.mb-5 El programa de manejo de residuos debe incluir capacitación, reciclaje, almacenamiento y disposición final, orientados a la gestión integral de residuos sólidos, líquidos o gaseosos, así como a los residuos peligrosos, con el fin de evitar riesgos en la salud de los trabajadores.
    ...
    .row.justify-content-center.mb-5
      .col-lg-8
        p.mb-4 Según la Ley 1562 de 2012 emitida por el Ministerio de Salud y Protección Social, en el Artículo 3  se indica que el accidente de trabajo es todo suceso repentino que sobrevenga por causa o con ocasión del trabajo, y que produzca en el trabajador una lesión orgánica, una perturbación funcional o psiquiátrica, invalidez o la muerte. 
        p Los accidentes de trabajo son aquellos que se producen durante la ejecución de órdenes del empleador o contratante, o durante la ejecución de una labor bajo su autoridad, aún fuera del lugar y horas de trabajo, o cuando se produzca durante el traslado de los trabajadores o contratistas desde su residencia a los lugares de trabajo o viceversa, cuando el transporte lo suministre el empleador y cuando por el ejercicio de la función sindical, aunque el trabajador se encuentre en permiso sindical siempre que el accidente se produzca en cumplimiento de dicha función. 
      .col-lg-4
        figure
    ...
    p.mb-5 Para el año 2020 y 2021, además es importante tener estadísticas de la prevalencia e incidencia de la enfermedad por SARS-CoV2.

    div.cajon.color-primario.p-5.mb-5(style="background-color:#FEF6E1 !important")
      p.mb-0 Los indicadores deben estar actualizados, archivados y disponibles mínimo los de los dos últimos años. Los indicadores de seguridad y salud en el trabajo de los que se exige tener estadísticas están relacionados en la siguiente tabla:
